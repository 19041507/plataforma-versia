...
2. **`builds` no vercel.json** — o painel da Vercel não aplica Build/Install customizados; o `build_files.sh` roda ao compilar o pacote `./_vercel_build` (última linha do `requirements.txt`).
