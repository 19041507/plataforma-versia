        ...
        <header className="sticky top-0 z-40 bg-black/40 backdrop-blur-xl border-b border-white/5 pl-20 pr-4 md:px-8 py-4 relative">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              ...
              className="px-3 md:px-6 py-2.5 md:py-3 rounded-xl font-semibold text-white flex items-center gap-2 hover:scale-105 transition-all text-sm md:text-base flex-shrink-0"
